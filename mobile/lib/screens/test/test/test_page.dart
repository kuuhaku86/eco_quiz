      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(padding: EdgeInsets.all(mediaQuerySize.height * 0.03)),
              Text(
              ...
              listJawaban(
                context,
                soalJawaban[currentCourse][numTes][1],
                soalJawaban[currentCourse][numTes][5],
              ),
              listJawaban(
                context,
                soalJawaban[currentCourse][numTes][2],
                soalJawaban[currentCourse][numTes][5],
              ),
              listJawaban(
                context,
                soalJawaban[currentCourse][numTes][3],
                soalJawaban[currentCourse][numTes][5],
              ),
              listJawaban(
                context,
                soalJawaban[currentCourse][numTes][4],
                soalJawaban[currentCourse][numTes][5],
              ),
            ],
          ),
